...
def build_equations(reactant_atoms, product_atoms):
    ...
    product_coefficients = product_coefficients[:-1] + [1]  # fix last coefficient to 1
...
def my_solve(equations, coefficients):
    ...
    solution = solution_list[0]  # take first dict

    # convert SymPy Rationals to Python Fraction for exact comparison
